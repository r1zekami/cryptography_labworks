...
// not my implementation, i just add something for my purposes
...
public:
    static std::vector<uint8_t> GenerateIV()
    {
        ...
        boost::random::uniform_int_distribution<uint8_t> dist(1, 255);
    ...
    static std::vector<uint8_t> PadMessage(std::vector<uint8_t> data)
    {
        return PKCS7_Padding(data, 16);
    }

    static std::vector<uint8_t> UnpadMessage(std::vector<uint8_t> data)
    {
        return PKCS7_Unpadding(data);
    }
// -----
